...
function programmerSurbrillanceMots(texteComplet, audio, entrees, timersRef) {
  ...
  audio.addEventListener('playing', () => {
    setTimeout(() => {
      ...
      // bord réellement utilisées (dossiers/collaborateurs) anticipent
      // maintenant aussi. Ces dernières en ont particulièrement besoin : ce
      // sont 2 highlights DE COLONNE enchaînés dans la même réplique
      // ('Ouvrir'), chacun avec un vrai coût (scroll + halo, voir
