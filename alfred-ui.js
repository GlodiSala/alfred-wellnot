...
function creerScene() {
  ...
  style.textContent = `
    ...
    #alfred-scene-marque-base { font-family:'AlfredMarque',-apple-system,'Segoe UI',sans-serif; margin-top:.45em; font-size:clamp(11px, .9vw, 15px); font-weight:600; letter-spacing:.2px; opacity:.88; }
