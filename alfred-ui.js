...
<svg id="alfred-svg" viewBox="0 0 379.79 383.47"
     xmlns="http://www.w3.org/2000/svg" style="overflow:visible;width:155px;height:155px;">
  ...
  <g id="alfred-lids" style="display:none;">
    <path stroke="#14b0bd" stroke-width="5" stroke-linecap="round" fill="none"
      d="M128.39,78.17 Q141.97,88.1 155.55,78.17"/>
    ...
    <path stroke="#14b0bd" stroke-width="5" stroke-linecap="round" fill="none"
      d="M224.52,78.17 Q238.10,88.1 251.68,78.17"/>
  ...
  <ellipse id="alfred-mouth-talk" fill="#14b0bd"
    cx="189" cy="128" rx="20" ry="0" style="display:none;"/>
...
function initAlfredUI() {
  ...
  style.textContent = `
    ...
    #alfred-zzz { position:absolute; top:50px; right:25px; pointer-events:none; opacity:0; transition:opacity .4s ease; z-index:10; }
    ...
    #alfred-avatar-wrap { position:relative; width:180px; height:180px; display:flex; align-items:center; justify-content:center; flex-shrink:0; background:#fff; border-radius:50%; box-shadow:0 4px 20px rgba(5,69,97,.3); }
    #alfred-dots { position:absolute; top:8px; left:50%; transform:translateX(-50%); display:flex; gap:5px; opacity:0; transition:opacity .3s ease; z-index:2; }
