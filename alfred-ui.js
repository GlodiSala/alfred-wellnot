...
function creerScene() {
  ...
  style.textContent = `
    /* Police de marque EMBARQUÉE (10/09). Avant : une pile de polices
       système ('Avenir Next', 'Century Gothic', Segoe UI...) — le lockup
       changeait donc de dessin d'une machine à l'autre, et retombait sur
       une grotesque générique là où aucune n'existe. Ici la fonte voyage
       avec le script, en woff2 sous-ensemblée aux seuls caractères utilisés
       (7 Ko) et encodée en base64 : rendu identique partout, et AUCUN appel
       réseau au moment de la démo — un chargement de police qui échoue en
       salle se verrait immédiatement sur le titre.
       Quicksand est une géométrique à terminaisons arrondies, la plus
       proche du dessin de la marque parmi les fontes libres. Ce reste une
       APPROXIMATION : si le fichier officiel du logo arrive, il remplace
       ce bloc et les deux règles qui l'utilisent. */
    @font-face { font-family:'AlfredMarque'; font-style:normal; font-weight:400 900; font-display:block;
      src:url(data:font/woff2;base64,) format('woff2'); }
    /* Graisse fine pour la baseline : sur la charte, "designed by
       notaries" est nettement plus léger que le mot lui-même — le
       composer dans la même graisse que le logo écrasait le contraste
       entre les deux lignes. */
    @font-face { font-family:'AlfredMarqueFine'; font-style:normal; font-weight:100 500; font-display:block;
      src:url(data:font/woff2;base64,) format('woff2'); }
    ...
    #alfred-scene-fond { position:absolute; inset:0;
      background:
        radial-gradient(120% 90% at 88% 8%, #fbb877 0%, #f9c98e 16%, #f0e3c0 34%, rgba(240,227,192,0) 62%),
        linear-gradient(118deg, #06323f 0%, #084456 22%, #0f8ba0 46%, #16aebb 60%, #7fd2cf 76%, #cfe4c6 100%); }
    /* Voile sombre en haut de scène. Le premier réglage du dégradé (repris
       ici à la demande) fait remonter le crème jusqu'au centre du haut,
       exactement là où se pose le lockup BLANC — sans ce voile il s'y
       perdait. C'est le même procédé qu'un bandeau titre de vidéo : très
       peu marqué, il ne se lit pas comme un rectangle, il rend juste le
       haut assez sombre pour que le blanc tienne. */
    #alfred-scene-voile { position:absolute; left:0; right:0; top:0; height:26vh; pointer-events:none;
      background:linear-gradient(180deg, rgba(4,40,52,.42) 0%, rgba(4,40,52,.18) 45%, rgba(4,40,52,0) 100%); }
    ...
    #alfred-scene-final-merci { font-family:'AlfredMarque',-apple-system,'Segoe UI',sans-serif; font-size:clamp(34px, 4.8vw, 74px); font-weight:600; color:#fff; letter-spacing:-.5px; text-shadow:0 3px 22px rgba(4,40,52,.38); }
    ...
    #alfred-scene-final-stand { margin-top:.9em; display:inline-block; padding:.55em 1.1em; border-radius:999px; background:rgba(255,255,255,.75); border:1.5px solid rgba(20,176,189,.5); color:#054561; font-size:clamp(13px, 1.2vw, 20px); font-family:'AlfredMarque',-apple-system,'Segoe UI',sans-serif; font-weight:600; }
    ...
    #alfred-scene-marque-mot { font-family:'AlfredMarque',-apple-system,'Segoe UI',sans-serif; font-size:clamp(30px, 3vw, 52px); font-weight:600; letter-spacing:-.2px; line-height:1; }
    #alfred-scene-marque-base { font-family:'AlfredMarqueFine',-apple-system,'Segoe UI',sans-serif; margin-top:.5em; font-size:clamp(11px, .95vw, 16px); font-weight:300; letter-spacing:.3px; opacity:.95; }
